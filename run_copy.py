...
# from src.callback.callback import CMyCallback
# from src.movement_detection.detect_movement import MovementDetection
from annv2c import NewPrediction

# port_arduino = 'COM 4'
# toArduino = serial.Serial(port_arduino,9600, timeout=1) #nama port, baurate   #ketika run arduino harus konek dan cocokin kedua item ini
...
while status:
    ...
    if responses['moved'] == '1':
        ...
        print('conveyor stop {}'.format(conveyor_stoped))
        ...
        #move arm
        time.sleep(1)
        arm_moved = toArduino1.write( str.encode(result['index'])) #data yg terinput akan ditampilkan LCD dan diakhiri enter
